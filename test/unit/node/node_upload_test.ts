...
describe('uploader', () => {
  describe('Input is a string path', () => {
    ...
    it('should get the file stat of a file', async () => {
      const client = new Client({auth: new FakeAuth()});
      const fileStats =
    ...
    it('should upload the file as stream with exact DEFAULT_CHUNK_SIZE except the last chunk',
       async () => {
         const client = new Client({auth: new FakeAuth()});
         const numRequests = Math.ceil(
             TEST_FILE_SIZE / DEFAULT_CHUNK_SIZE,
         );
  ...
  describe('Input is a blob', () => {
    ...
    it('should get a readable stream of a file with exact DEFAULT_CHUNK_SIZE except the last chunk',
       async () => {
         const client = new Client({auth: new FakeAuth()});
         const numRequests = Math.ceil(
             TEST_FILE_SIZE / DEFAULT_CHUNK_SIZE,
